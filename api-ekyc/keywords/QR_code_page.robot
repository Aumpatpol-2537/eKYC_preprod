...
***Variables***
${CID_AUM}        jzoyaYvHxfMTTtRy9N/8jwBmZHBm3l6IkCmNcawbA8haeGlrOTb8Gpo=
...
# Generate_QR_Code_for_test_qrstamp_scene
    ...
    # Create_File_Keep_Text                                   { "cid": "${CID_AUM}", "twin_status": true, "twins_gender": "male", "journey_code": "JN003" }
    # Encrypt_page.Encrypt_Function_with_long_Text            keep_text.txt      
    # Encrypt_page.Read_File_Encrypt                          encrypt_text.txt        
    # &{body}=      Create dictionary        data=${RESULT_ENCRYPT_DATA}
...
Generate_QR_Code_for_test_qrstamp_scene
    ...
    &{body}=        Create dictionary       cid=0I8SfCnkwkptBl1Z50x6mYNe0lbdJCRxMApy/0EMeYFwu59LCQxgxs4=      twins_status=     twins_gender=   journey_code=JN003         
